...
export default function FileDetails() {
    ...
    const canDownload = !!data?.stampId;
            ...
            <section className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div className="bg-white dark:bg-neutral-900 border border-gray-200 dark:border-neutral-800 rounded-xl shadow-sm">
                    ...
                    <div className="mt-4 space-y-3">
                        ...
                        title={!canDownload ? "Aún no hay sello asociado" : "Descargar proof .ots"}
                        >
                        ...
                        title={!canDownload ? "Aún no hay sello asociado" : "Descargar certificado"}
                        >
